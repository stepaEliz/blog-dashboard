<template>
  <div
    class="w-full sm:w-auto flex flex-col gap-2 p-4 rounded-lg shadow-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 transition-all duration-300 hover:scale-[1.02]"
  >
    <!-- Title -->
